...
const Resume = (props) => {
    ...
    const workExContant1 = (props.lan==='en')? <p className='info' > Security Shift Manager - securied facility <ul><li className='' > &bull; managed up to 30 guards for shift</li></ul> </p>:<p className='info he' dir="rtl">אחמש אבטחה פיזית – מתקן בטחוני. <ul><li className='he' dir="rtl">&bull; אחראי על משמרות של עד ל30 איש. </li></ul></p>
